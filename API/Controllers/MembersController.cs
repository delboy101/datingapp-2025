...
namespace API.Controllers
{
        ...
        IPhotoService photoService) : BaseApiController
    {
        ...
        {
            var isCurrentMemeber = id == User.GetMemberId();
            return Ok(await uow.MemberRepository.GetPhotosForMemberAsync(id, isCurrentMemeber));
        }
        ...
        public async Task<ActionResult> SetMainPhoto(int photoId)
        {
            ...
            if (photo == null || member.ImageUrl == photo.Url) return BadRequest("Cannot set as main photo");
